// Benchmarks for using integers to store boolean values
...
// Uses a constant that is not a power of two
static void intBenchNonPower(benchmark::State &s) {
...
BENCHMARK(intBenchNonPower)->DenseRange(12, 14)->Unit(benchmark::kMicrosecond);
