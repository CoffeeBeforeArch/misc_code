...
// Uses a value that is only known at runtime
static void intBenchInput(benchmark::State &s) {
...
BENCHMARK(intBenchInput)->DenseRange(12, 14)->Unit(benchmark::kMicrosecond);
